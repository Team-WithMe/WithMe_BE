...
public class MyPageController {
    ...
    @ApiResponses(value = {
        ...
        , @ApiResponse(responseCode = "406", description = "토큰의 유저 id와 pathVariable의 id가 불일치", content = @Content(schema = @Schema(implementation = ExceptionResponseDto.class)))
    })
    ...
    public ResponseEntity<Object> getUserAndTeamInfo(@PathVariable Long userId, @RequestHeader("Authorization") String authHeader) {
        ...
        if(!tokenProvider.getUserIdFromToken(authHeader).equals(userId)){
