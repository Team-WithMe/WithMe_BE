...
@Schema(description = "팀 댓글 수정 응답 DTO 객체")
@Getter
@Setter
@NoArgsConstructor
public class TeamCommentModifyResponseDto {
    ...
    public TeamCommentModifyResponseDto(Integer status, Long teamId, Long commentId) {
        this.status = status;
        this.teamId = teamId;
